...
object ModPatterns {
    ...
    val USE_NUMBERED_SITE =
        Regex("""#(?:selectsite|newsite|req_nositenbr|addsite|removesite|hiddensite|futuresite|onlyatsite)\s+(\d+)(.*)$""")
